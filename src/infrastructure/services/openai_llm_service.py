...
class OpenAILLMService(LLMService):
    ...
    async def generate_response(
        ...
        try:
            ...
            logger.error(f"Failed to generate response using OpenAI: {str(e)}")
    ...
    def get_token_limits(self) -> Dict[str, int]:
        ...
        limits = {
            ...
            "gpt-5-nano": 4096,  # Assuming similar to gpt-3.5-turbo
        }

        return {
            "max_tokens": limits.get(self.model, 4096),
            "max_prompt_tokens": limits.get(self.model, 4096)
